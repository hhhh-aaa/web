...
INSERT INTO `account` (`id`, `username`, `fullname`, `password`, `role`) VALUES
	(1, 'user1', 'ád', '$2y$10$IN6QAsOoLEFbU45E4Gsnf.IvjFmiX4WcZ9A3SR/.TBH5g7E8tmY.m', 'admin'),
	(2, 'user2', 'aw', '$2y$10$6Fj27/VLlgZhbZN101nQ4eNsKSUkzwAk439ziDydUiNiP2J.vCLGC', 'user');
...
INSERT INTO `product` (`id`, `name`, `description`, `price`, `image`, `category_id`) VALUES
	(9, 'iPhone 14', 'Điện thoại iPhone 14 mới nhất của Apple', 23999.99, 'uploads/iPhone-14-thumb-trang-600x600.jpg', 1),
	...
	(12, 'Dell XPS 13', 'Laptop Dell XPS 13 với vi xử lý Intel Core i7', 22999.99, 'uploads/dell-xps-13-9340-ultra-7-hxrgt2-1-638708028116982814-750x500.jpg', 2),
