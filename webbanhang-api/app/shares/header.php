...
<head>
    ...
    <style>
        ...
        .navbar {
            background: linear-gradient(90deg, #6c757d, #7366FF); /* Gradient background */
        }
        .navbar .nav-link {
        ...
        .navbar-toggler {
            border-color: white; /* Toggler border color */
        }
        .navbar-toggler-icon {
            background-image: url("data:image/svg+xml;charset=utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 30 30'%3E%3Cpath stroke='white' stroke-width='2' d='M4 7h22M4 15h22M4 23h22'/%3E%3C/svg%3E"); /* White toggler icon */
        }
        .product-image {
            max-width: 100px;
            height: auto;
        ...
        .promo-banner {
            background-color: #FF6CAB; /* Banner background color */
            color: white; /* Text color */
            padding: 10px 0; /* Padding for the banner */
            text-align: center; /* Center the text */
            border: 2px solid #FF3B6A; /* Border color and thickness */
        ...
        .navbar-brand img {
            width: 150px; /* Thay đổi kích thước logo tại đây */
